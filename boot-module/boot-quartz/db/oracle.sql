...
INSERT INTO schedule_job (id, bean_name, params, cron_expression, status, remark, creator, create_date, updater, update_date) VALUES (1067246875800000144, 'testTask', 'boot', '0 0/30 * * * ?', '1', '有参数测试', 1067246875800000001, CURRENT_DATE, 1067246875800000001, CURRENT_DATE);
