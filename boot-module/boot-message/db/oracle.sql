...
INSERT INTO sys_mail_template(id, name, subject, content, create_date) VALUES (1067246875800000147, '验证码模板', 'BootCloud注册验证码', '<p>BootCloud注册验证码：${code}</p>', CURRENT_DATE);
