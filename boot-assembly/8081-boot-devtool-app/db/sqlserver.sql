...
INSERT INTO sys_menu(id, pid, url, open_style, permissions, menu_type, icon, sort, del_flag, creator, create_date, updater, update_date) VALUES (1302850783288614913, 1305532398162145281, 'devtool/datasource', 0, '', 0, 'icon-sync', 0, 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
INSERT INTO sys_menu(id, pid, url, open_style, permissions, menu_type, icon, sort, del_flag, creator, create_date, updater, update_date) VALUES (1302862890696564738, 1305532398162145281, 'devtool/fieldtype', 0, '', 0, 'icon-eye', 1, 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
INSERT INTO sys_menu(id, pid, url, open_style, permissions, menu_type, icon, sort, del_flag, creator, create_date, updater, update_date) VALUES (1302874751835848705, 1305532398162145281, 'devtool/baseclass', 0, '', 0, 'icon-info-circle', 3, 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
INSERT INTO sys_menu(id, pid, url, open_style, permissions, menu_type, icon, sort, del_flag, creator, create_date, updater, update_date) VALUES (1304802103569809410, 1302850622416084993, 'devtool/generator', 0, '', 0, 'icon-tags', 0, 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
INSERT INTO sys_menu(id, pid, url, open_style, permissions, menu_type, icon, sort, del_flag, creator, create_date, updater, update_date) VALUES (1305513187675144193, 1305532398162145281, 'devtool/param', 0, '', 0, 'icon-setting', 5, 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
...
INSERT INTO sys_params(id, param_code, param_value, param_type, remark, del_flag, creator, create_date, updater, update_date) VALUES (1067246875800000072, 'DEV_TOOLS_PARAM_KEY', '{"packageName":"io.boot"version":"3.0","author":"Mark","email":"sunlightcs@gmail.com","backendPath":"D:\\renrenio\\boot-cloud-tenant\\boot-admin","frontendPath":"D:\\renrenio\\boot-cloud-tenant-admin"}', 0, '代码生成器配置信息', 0, 1067246875800000001, getdate(), 1067246875800000001, getdate());
...
INSERT INTO gen_datasource(id, db_type, conn_name, conn_url, username, password, status, create_date) VALUES (1302855887882412034, 'MySQL', '本地', 'jdbc:mysql://localhost:3306/renren_cloud?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&nullCatalogMeansCurrent=true', 'boot', '123456', 0, getdate());
...
INSERT INTO gen_test_data(id, username, real_name, gender, email, notice_type, content, creator, create_date, updater, update_date) VALUES (1067246875800000001, 'sunlightcs', 'Mark', 0, 'root@boot.io', 0, '<p>BootCloud代码生成器！</p>', 1067246875800000001, getdate(), 1067246875800000001, getdate());
