...
package io.boot.commons.log.aspect;

import io.boot.commons.log.SysLogOperation;
import io.boot.commons.log.annotation.LogOperation;
import io.boot.commons.log.enums.LogTypeEnum;
import io.boot.commons.log.enums.OperationStatusEnum;
...
public class LogOperationAspect {
    ...
    @Pointcut("@annotation(io.boot.commons.log.annotation.LogOperation)")
